import { Button, Box, Text, Flex, Input, HStack, InputGroup, InputRightElement } from '@chakra-ui/react'
import { AvailableStakeTokenButtons, AvailableStakeTokenInfoBox } from './StakingPoolItem'
